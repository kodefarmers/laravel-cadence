...
beforeEach(function (): void {
    ...
    app()->singleton(CadenceConfig::class, fn () => new CadenceConfig(
        freeAttempts: 3,
        idleTimeout: 3600,
    ));

    app()->singleton(StateRepository::class, fn () => new FakeStateRepository());
});
...
it('uses the configured default driver', function (): void {
    app()['config']->set('cadence.default', 'exponential');
